...
class PembelianPP extends StatefulWidget {
  @override
  _PembelianPPState createState() => _PembelianPPState();
}

class _PembelianPPState extends State<PembelianPP> {
  OrderServices orderService = OrderServices();
  bool onSearch = false;
  String searchQuery = '';
  sortedBy sorted = sortedBy.Default;
  Stream<List<SalesOrder>> orderStreams;
  PejabatPengadaan penerima ;
  ...
  void didChangeDependencies() {
    penerima = Provider.of<Auth>(context, listen: false).getUserInfo as PejabatPengadaan;
    orderStreams = orderService.getUnitActiveSalesOrder(penerima.unit);
